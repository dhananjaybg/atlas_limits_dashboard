...
class MongoDBAtlasClient:
    def __init__(self, public_key=None, private_key=None):
        ...
        if self.public_key and self.private_key:
            ...
            test_response = requests.get("https://cloud.mongodb.com/admin/nds/orgs/64ca747b952bcb462e491b03/limits", auth=self.auth)
    ...
    def get_project_custom_roles(self, project_id: str) -> List[Dict]:
        ...
        return data['customDBRoles'] if data else [] #data.get('results', []) if data else []
